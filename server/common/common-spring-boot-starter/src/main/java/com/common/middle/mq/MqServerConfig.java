...
//            if (ack) {
//                LogUtils.info("消息成功发送到Exchange",correlationData, ack, cause);
//            } else {
//                LogUtils.info("消息发送到Exchange失败, {}, cause: {}", correlationData, cause);
//            }
//        });
...
//            LogUtils.info("消息从Exchange路由到Queue失败: exchange: {}, route: {}, replyCode: {}, replyText: {}, message: {}", exchange, routingKey, replyCode, replyText, message);
//        });
