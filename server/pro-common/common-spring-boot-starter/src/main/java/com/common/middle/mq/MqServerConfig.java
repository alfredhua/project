...
//            if (ack) {
//                LogUtil.info("消息成功发送到Exchange",correlationData, ack, cause);
//            } else {
//                LogUtil.info("消息发送到Exchange失败, {}, cause: {}", correlationData, cause);
//            }
//        });
...
//            LogUtil.info("消息从Exchange路由到Queue失败: exchange: {}, route: {}, replyCode: {}, replyText: {}, message: {}", exchange, routingKey, replyCode, replyText, message);
//        });
