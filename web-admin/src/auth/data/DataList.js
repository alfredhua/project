...
import { Breadcrumb,Card,Modal,Input,message } from 'antd';
	...
	render(){
		...
		return(
			<div>
				...
				<Modal title="创建" visible={this.state.visible} onOk={()=>{this.save()}}
					onCancel={()=>{this.setState({visible:false,code:null,name:null})}}>
