...
export const default_meta={
  title:"首页-ALFRED的个人博客",
  keywords:"华,ALFRED,ALFRED博客,ALFRED的博客,个人博客,alfredhua,alfredhua的博客,网站,网站建设,权限管理,技术,技术管理,java,面试,"+
  "redis,docker,dubbo,swagger,swagger2,grpc,zk,zookeeper,产品,自动化测试,工具,设计模式,并发",
  description:"首页-ALFRED的个人博客,alfredhua,alfredhua.com,个人博客,博主,本项目是自研发的一套博客网站类系统,相应的开发出一套完整的代码生成工具。"+
